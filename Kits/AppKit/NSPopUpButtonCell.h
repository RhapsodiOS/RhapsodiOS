...
- (BOOL)altersStateOfSelectedItem;
    // This only has an effect for popups (it is ignored for pulldowns).  If YES (the default) then the selected item gets its state set to NSStateOn.  If NO the items in the menu are left alone.
