 ...
 *
 * Burgundy Audio Driver for PowerMac/iMac
 *
...
#define DRV_TITLE       "PPCBurgundy"

@interface PPCBurgundyDriver : IOAudio
{
@private
    void *_burgundy_private;  /* Pointer to burgundy_state structure */
}
...
/* Extended methods for Burgundy-specific controls */
