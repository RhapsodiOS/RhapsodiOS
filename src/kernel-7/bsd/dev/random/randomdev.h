...
/* Report an estimate of the accumulated entropy, in bits (int *arg). */
#define RANDOM_GETENTROPY	_IOR('R', 1, int)
...
int random_ioctl(dev_t dev, u_long cmd, caddr_t data, int fflag,
    struct proc *pp);
