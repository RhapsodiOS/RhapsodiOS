...
from binrecon.normalize import (
    ...
    endpoint_key, instruction_key, integer_key, normalize_analysis,
    range_key, reference_key, relocation_key, section_key,
)
from binrecon.schema import CONSENSUS_MAX_JSON_NODES, preflight_json
...
def validate_consensus(document: dict) -> None:
    ...
    preflight_json(document, ConsensusError, max_nodes=CONSENSUS_MAX_JSON_NODES)
